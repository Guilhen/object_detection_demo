...
def visualize_boxes_and_labels_on_image_array(
  ...
  dictionnary_of_label_and_coordinates={}
  ...
  for box, color in box_to_color_map.items():
    ...
    name_and_probability=(box_to_display_str_map[box][0])
    name_and_probability.split(':')

    name_class=name_and_probability.split(':')[0]

    dictionnary_of_label_and_coordinates[str(name_class)+':'+str(i)]=[xmin,xmax,ymin,ymax,[(xmax+xmin)/2,(ymax+ymin)/2]]
    i+=1

  return(image,dictionnary_of_label_and_coordinates)
